...
function template_img() {
   $("#video_stream").prepend('<img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs" id="init_img" width="695" height="460" alt="" />');
   //initialise img tag
...
$(document).ready(function() {
   ...
   $("#stop_btn").click(function(e) {
      e.preventDefault();
      $.when(
      ajax_call('/tp_ser_wbsrv/video_feed/stop', contentype_txt, 'json',
